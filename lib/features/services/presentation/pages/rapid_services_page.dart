...
class _RapidServicesPageState extends State<RapidServicesPage> {
  ...
  void _openService(ServiceItem item) {
    ...
    if (key.contains('hebergement')) {
      Navigator.push(
        context,
        MaterialPageRoute(builder: (_) => const LodgingServicesPage()),
      );
      return;
    }
    if (key.contains('vivre')) {
      Navigator.push(
        context,
        MaterialPageRoute(builder: (_) => const LivingServicesPage()),
      );
      return;
    }
    ...
    return const [
      ServiceSection(
        ...
        items: [
          ServiceItem(
            title: 'Gestion Immo',
            sub: 'Locataire, Proprietaire, Commissionnaire',
            icon: Icons.apartment_outlined,
            color: Color(0xFF26A69A),
          ),
          ServiceItem(
            title: 'Menage & Aide',
            sub: 'Nounou, Jardinier, Vigile',
          ...
          ServiceItem(
            title: 'Hebergement',
            sub: 'Hotel, auberge, residence',
            icon: Icons.hotel_rounded,
            color: Color(0xFF8E24AA),
          ),
          ServiceItem(
            title: 'Vivre',
            sub: 'Boutique, alimentation, cabine...',
      ...
      ServiceSection(
        ...
        items: [
          ServiceItem(
            title: 'Mobilite',
            sub: 'Taxi, Location, Auto',
            icon: Icons.directions_car_filled_outlined,
            color: Color(0xFF5C6BC0),
          ),
          ServiceItem(
            title: 'Depannage & Auto',
            sub: 'Garage, Mecanicien, Pneus',
      ...
      ServiceSection(
        ...
        items: [
          ServiceItem(
            title: 'Formation',
            sub: 'Cours, Soutien, Pro',
            icon: Icons.school_outlined,
            color: Color(0xFF2ECC71),
          ),
          ServiceItem(
            title: 'Evenements',
            sub: 'DJ, Traiteur, Deco',
            icon: Icons.music_note_outlined,
            color: Color(0xFFE91E63),
          ),
          ServiceItem(
            title: 'Administration',
            sub: 'Documents, Taxes, RDV',
...
class ServiceSection {
  ...
  ServiceSection copyWith({String? title, List<ServiceItem>? items}) {
      ...
      children: [
        Container(
          ...
          decoration: BoxDecoration(
            ...
            boxShadow: [
              BoxShadow(
                color: const Color(0xFFFB8C00).withOpacity(0.25),
                blurRadius: 14,
                offset: const Offset(0, 6),
              ),
            ],
